# Google Cloud Client Libraries for Swift - Transcoder API
...
Add `swift-google-cloud-video-transcoder-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-video-transcoder-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudVideoTranscoderV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudVideoTranscoderV1 <target-name> --package swift-google-cloud-video-transcoder-v1
```
