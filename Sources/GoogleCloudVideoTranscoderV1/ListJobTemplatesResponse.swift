...
public struct ListJobTemplatesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// List of job templates in the specified region.
  public var jobTemplates: [JobTemplate] = []
  ...
  /// Initialize a new instance of `ListJobTemplatesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListJobTemplatesResponse().with { $0.jobTemplates = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let jobTemplates = CodingKeys(stringValue: "jobTemplates")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([JobTemplate].self, forKey: .jobTemplates) {
      self.jobTemplates = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.jobTemplates, forKey: .jobTemplates)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.transcoder.v1.ListJobTemplatesResponse"
  }
