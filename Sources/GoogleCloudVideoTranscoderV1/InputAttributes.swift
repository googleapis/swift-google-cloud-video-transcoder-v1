...
public struct InputAttributes: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = InputAttributes().with { $0.trackDefinitions = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.transcoder.v1.InputAttributes"
  }
